...
abstract class ImprovedAbstractSimilarity extends AbstractItemSimilarity implements UserSimilarity {
   ...
   * </p>
   */
  ImprovedAbstractSimilarity(final DataModel dataModel, Weighting weighting, boolean centerData) throws TasteException {
    super(dataModel);
   ...
   */
  abstract double computeResult(int n, int nX, int nY, double sumXY, double sumX2, double sumY2, double sumXYdiff2);
  ...
  public double userSimilarity(long userID1, long userID2) throws TasteException {
    ...
    if (centerData) {
      ...
      result = computeResult(count, xLength, yLength, centeredSumXY, centeredSumX2, centeredSumY2, sumXYdiff2);
    } else {
      result = computeResult(count, xLength, yLength, sumXY, sumX2, sumY2, sumXYdiff2);
    }
