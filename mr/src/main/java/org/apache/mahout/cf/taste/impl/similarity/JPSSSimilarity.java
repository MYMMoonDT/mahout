...
public final class JPSSSimilarity implements UserSimilarity {
	...
	public JPSSSimilarity(DataModel dataModel) throws TasteException {
	...
	public double userSimilarity(long userID1, long userID2)
	    ...
	    return sumPIP * ((double)count / (double)(xLength + yLength - count));
	}
